...
URL = "https://github.com/g-mecha/ovos_test_lunch"
SKILL_CLAZZ = "LunchSkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-lunch"  # pip install PYPI_NAME
